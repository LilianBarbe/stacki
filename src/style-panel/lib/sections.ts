...
export const SECTIONS: readonly SectionDef[] = [
  ...
  },
  {
    id: 'spacing',
    label: 'Spacing',
    // The resolved model projects margin/padding shorthands into these sides.
    // Keep the authored shorthand in Custom properties as well: the box edits
    // individual longhands, while that row edits/clears the whole shorthand.
    order: [
