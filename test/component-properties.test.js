...
} = require('../electron/propertyDefinitions.mjs');
const { renameComponentReferences } = require('../electron/propertyRename.mjs');
const {
  loadComponentProperties,
  updateComponentProperties,
} = require('../electron/componentProperties.mjs');
const { applySourceEdits } = require('../electron/propertySyntax.mjs');
const {
  parseComponentProperties,
  parsePropertyChange,
  parsePropertiesResult,
  PROPERTY_LIMITS,
} = require('../shared/component-properties.mjs');
const source = `---
